 ...
 *
 * @providesModule DeprecatedMapView
 * @flow
 */
'use strict';

// We cannot use Haste in 3rd-party modules:
//
...
// Haste imports above rewritten as CommonJS imports:
 ...
 *
 * `DeprecatedMapView` is used to display embeddable maps and annotations using
 * `MKMapView`.
 *
 ...
 * import { DeprecatedMapView } from 'derprecated-react-native-ios-mapview';
 *
...
const RCTMap = requireNativeComponent('RCTMap', DeprecatedMapView, {
  nativeOnly: {
